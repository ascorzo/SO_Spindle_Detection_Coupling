...
str_datetime = strcat(string(year(datetime)), '-' ,string(month(datetime)),...
    '-' ,string(day(datetime)), '_', string(hour(datetime)), 'h-', string(minute(datetime)), 'm');

if strcmp(ChanVsSource,'Channel')
    save(strcat('spindleDensityInBin_',str_ChanSO,'vs',str_ChanSS,'_',OnVsOff, '_', str_datetime), 'spindleInBinTotalOdor','spindleInBinTotalPlacebo');
    save(strcat('spindlePowerInBin',str_ChanSO,'vs',str_ChanSS,'_',OnVsOff, '_', str_datetime), 'spindlePowerInBinTotalOdor','spindlePowerInBinTotalPlacebo');
    save(strcat('spindleDensity',str_ChanSO,'vs',str_ChanSS,'_',OnVsOff, '_', str_datetime), 'DensitySpindlesTotalOdor','DensitySpindlesTotalPlacebo');
    save(strcat('spindlePower',str_ChanSO,'vs',str_ChanSS,'_',OnVsOff, '_', str_datetime), 'PowerSpindlesTotalOdor','PowerSpindlesTotalPlacebo');
else
    save(strcat('spindleDensityInBin',str_ROI_SO,'vs',str_ROI_SS,'_',OnVsOff, '_', str_datetime), 'spindleInBinTotalOdor','spindleInBinTotalPlacebo');
    save(strcat('spindlePowerInBin',str_ROI_SO,'vs',str_ROI_SS,'_',OnVsOff, '_', str_datetime), 'spindlePowerInBinTotalOdor','spindlePowerInBinTotalPlacebo');
    save(strcat('spindleDensity',str_ROI_SO,'vs',str_ROI_SS,'_',OnVsOff, '_', str_datetime), 'DensitySpindlesTotalOdor','DensitySpindlesTotalPlacebo');
    save(strcat('spindlePower',str_ROI_SO,'vs',str_ROI_SS,'_',OnVsOff, '_', str_datetime), 'PowerSpindlesTotalOdor','PowerSpindlesTotalPlacebo');
end
